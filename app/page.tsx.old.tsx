  ...
  return (
    <>
      <div className="flex flex-col items-center justify-top min-h-screen py-2 pt-28 relative overflow-hidden bg-[#f7faf6]">
        ...
        <h1 className="mx-3  sm:text-5xl font-[500px] text-[#191d18] pt-4 text-center relative z-10 animate-fade-in-up">
...
function ServicesOverview() {
  // Using the same services data as in the services page for consistency
  const services = [
    {
